...
for episode in episodes:
    ...
    object_states = np.load(
        os.path.join(ep_dir, "object_states.npy")
    )

    joint_positions = np.load(
        os.path.join(ep_dir, "joint_positions.npy")
    )

    joint_velocities = np.load(
        os.path.join(ep_dir, "joint_velocities.npy")
    )

    eef_positions = np.load(
        os.path.join(ep_dir, "eef_positions.npy")
    )

    eef_quaternions = np.load(
        os.path.join(ep_dir, "eef_quaternions.npy")
    )
